...
<div id="mainPart">
    ...
    <div class=" h-100 d-flex justify-content-center align-items-center" >
        <div class="  m-5 container w-50">
            <div class="row ">
                <button type="button" class="btn btn-outline-dark col m-5 " style="height: 10vh;" id="usersOption">Users</button>
            ...
            <div class="row">
                ...
                <button type="button" class="btn btn-outline-dark col m-5 " style="height: 10vh;" id="productsOption">Products</button>
            </div>
            <!-- <div class="row">
